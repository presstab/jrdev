"""
Go language parsing utilities for function detection and manipulation.
"""
import re

def parse_go_signature(signature: str):
    """
...
def parse_go_functions(filepath):
    """
    ...
    while line_idx < total_lines:
        ...
        if method_match:
            ...
            if not is_control_structure(method_name):
        ...
        # Check for function definition
            ...
            if function_match:
                ...
                if not is_control_structure(function_name):
