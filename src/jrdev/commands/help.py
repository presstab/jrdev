...
async def handle_help(app: Any, args: List[str], worker_id: str):
    ...
    app.ui.print_text(f"  {cmd_format}{format_command_with_args('/model', '<model_name>')}{reset} - Change model", print_type=None)
...
async def handle_help_plain(app: Any, args: List[str]):
    ...
    app.ui.print_text("  /model <model_name> - Change model", print_type=None)
