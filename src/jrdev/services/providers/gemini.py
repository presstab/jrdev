...
async def fetch_gemini_models(core_app: Any):
    """
    Fetches model data from the Gemini API and formats it into the internal model list structure.
    """
